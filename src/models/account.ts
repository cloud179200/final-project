...
export interface IShopSettingsValidation {
  code: string;
  companyName: string;
  description: string;
  id: string;
...
export interface IFinancialDetail {
  hasSpecialRevshareFeeDst: string;
  hasSpecialRevshareFeeShipping: string;
  specialRevshareFeeDst: string;
  specialRevshareFeeShipping: string;
  us_tax_calculate_for: string;
  us_tax_states: string;
}
export interface IFinancialDetailValidation {
  hasSpecialRevshareFeeDst: string;
  hasSpecialRevshareFeeShipping: string;
  specialRevshareFeeDst: string;
  specialRevshareFeeShipping: string;
