...
const UserFilter = (props: Props) => {
  const { getStates, setFilterByPage, initialFilter } = props;
  ...
  return (
    <Box sx={{ display: 'flex', justifyContent: 'center', alighItems: 'center', backgroundColor: '#323259' }}>
      <Grid container width={1}>
        ...
        >
          <Box
            ...
            p={1}
            sx={{
              borderBottom: openMoreFilter ? '1px solid #1B1B38' : '',
              display: 'flex',
              justifyContent: 'space-around',
              alignItems: 'center',
            }}
          >
            ...
            <Button color="secondary" variant="contained" sx={{ width: '10%' }} onClick={handleSearchClick}>
              Search
            </Button>
          </Box>
          <Box component="div" width={1} flexGrow={1} sx={{ position: 'relative' }}>
            ...
            >
              {openMoreFilter ? <KeyboardDoubleArrowUpRounded /> : <KeyboardDoubleArrowDownRounded />}
            </Button>
