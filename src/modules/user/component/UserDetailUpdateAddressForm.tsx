...
import { validationUpdateAddressUserSchema } from '../utils';
...
const UserDetailUpdateAddressForm = (props: Props) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: validationUpdateAddressUserSchema,
    onSubmit: (values) => {
      const {
        id,
        address,
  ...
  useEffect(() => {
    ...
    formik.setValues({
      ...
      tax,
      zip_code,
      is_billing: addressToUpdate.is_billing === 1 ? true : false,
      is_shipping: addressToUpdate.is_shipping === 1 ? true : false,
    });
